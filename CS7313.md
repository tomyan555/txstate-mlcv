...
*    Topic 1. Introduction (Jan 16)
*    Topic 2. Linear Regression, Gradient Descent (Jan 23)
*    Topic 3. Linear Regression with multiple variables (Jan 23)
*    Topic 4. Logistic Regression (Jan 30)
*    Topic 5. Regularization (Jan 30)
*    Topic 6. Support Vector Machines (Feb 6)
*    Topic 7. Clustering/Mixture Models (Feb 13)
*    Topic 8. Dimensionality Reduction (Feb 13)
*    Topic 9. Large-scale Machine Learning (Feb 20)
*    Topic 10. Sparse Learning (Feb 20)
*    Topic 11. Transfer and Multi-Task Learning (Feb 27)
*    Topic 12. Neural Network (Mar 6)
*    Topic 13. Deep Learning - Convolutional Neural Network (CNN) (Mar 27)
*    Topic 14. Deep Learning - Recurrent Neural Network (RNN) (April 3)
*    Topic 15. Deep Learning - Long Short-term Memory (LSTM) (April 10)
*    Topic 16. Deep Learning - Generative adversarial network (GAN) (April 17)
*    Project Presentation (April 24, May 1)
*    Mid Exam (Feb 27); Final Exam (May 8)
